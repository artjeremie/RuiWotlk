local function RuiWotlkBossBigFrame()
    for i = 1, MAX_BOSS_FRAMES do
        _G["Boss"..i.."TargetFrameHealthBar"]:SetStatusBarTexture("Interface\\Addons\\RuiWotlk\\Media\\Unitframes\\UI-StatusBar");
        _G["Boss"..i.."TargetFrameManaBar"]:SetStatusBarTexture("Interface\\Addons\\RuiWotlk\\Media\\Unitframes\\UI-StatusBar");
        ...
        _G["Boss"..i.."TargetFrameTextureFrameTexture"]:SetTexture("Interface\\Addons\\RuiWotlk\\Media\\Unitframes\\UI-UNITFRAME-BOSS");
