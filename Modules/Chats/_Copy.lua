...
local function CreateCopyButton(self)
    ...
    self.Copy:SetNormalTexture("Interface\\AddOns\\RuiWotlk\\Media\\Chat\\copynormal")
    self.Copy:GetNormalTexture():SetSize(20, 20)

    self.Copy:SetHighlightTexture("Interface\\AddOns\\RuiWotlk\\Media\\Chat\\copyhighlight")
